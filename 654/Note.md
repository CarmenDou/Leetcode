- Should pay attention to deep copy, we cannot just use list1 = list2, but list1 = list2[:]
...
- Or we can build a function instead of using a built-in function to find the max number.
